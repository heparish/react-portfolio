let resumeData = {
    ...
    "socialLinks":[
        ...
        {
          "name":"resume",
          "url":"https://drive.google.com/file/d/1jrx5-H8Nh6c9tZei3IZBhwc5gcSh4DB7/view?usp=sharing",
          "className":"fa fa-download"
        }
      ],
    "aboutme":" I am a recent graduate looking to launch my career in web development. I am eager to learn more programing languages and frameworks and start working on real life projects. When I am not at my computer reading documentation I can be found playing video games, reading, or crocheting.",
    ...
    "work":[
      {
        "CompanyName":"View my resume ",
        "urlR": "https://drive.google.com/file/d/1jrx5-H8Nh6c9tZei3IZBhwc5gcSh4DB7/view?usp=sharing",
      },
      // {
    ...
    "portfolio":[
      {
        ...
        "urlS":"https://pokemonstore1.herokuapp.com/",
        "url": "https://github.com/Ascension23/PokePound",
      },
      {
      ...
      },
      {
        ...
        "urlS": "https://github.com/heparish/bank-app/archive/refs/heads/main.zip",
      ...
      },
      {
        ...
        "urlS":"https://fitness-tracker-hep.herokuapp.com/?id=61354e60adc7aa00157dbc8c",
        "url": "https://github.com/heparish/Fitness-Tracker",
      }
    ],
    "testimonials":[
      {
        "description":"'Expert problem solver' is a thought that comes to mind when I think about my time spent working with Haley...",
        "name":"Scott Lawman, libraries web applications developer"
      },
      {
        "description":"Haley can take a concept and turn it into a finished product in no time.",
        "name":"Hayk Mnatsakanyan, full stack web developer"
      }
    ]
  }
